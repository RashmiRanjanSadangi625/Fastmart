  ...
  const handleAddToCart=()=>
    {
      const data ={
        ...
        discountPersent: products.product?.discountPersent,
      }
    ...
    // if (!product || !product?.ratings) return <p>Loading...</p>;

     // Extract ratings and reviews separately
  const ratings = products?.product?.ratings || [];
  const reviews = products?.product?.reviews || [];
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        {/* <nav aria-label="Breadcrumb">
          <ol role="list" className="mx-auto flex max-w-2xl space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-1">
        ...
        <div className="flex flex-col items-center">
          <div className='overflow-hidden rounded-lg max=w-[3-rem] max-h-[35rem]'>
          <img
          ...
          {/* Product info */}
        <div className="lg:col-span-1 mx-auto mx-w-2 px-4 pb-16 sm:px-6 lg:mx-width-7xl lg:px-8 lg:pb-24">
          <div className="lg:col-span-2">
            <h1 className="text-lg lg:text-lg font-semibold text-gray-900">{products.product?.brand}</h1>
            <h1 className='text-lg lg:text-xl opacity-60 text-gray-900 pt-2'>{products.product?.title}</h1>
          </div>

          {/* Options */}
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            <h2 className="sr-only">Product information</h2>
              <div className='flex space-x-5 items-center teaxt-lg lg:text-xl text-gary-900 mt-6'>
            ...
            <div className="mt-6">
              <div className='flex items-center space-x-5'>
                ...
                <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-400'>{totalReviews} Reviews</p> 
              </div>
            </div>
        ...
        <Grid container spacing={7}>
          ...
          <Grid item xs={7}>
            <div className="space-y-5">
              {ratings.length > 0 ? (
                ratings.map((rating) => {
                  const matchingReview = reviews.find((review) => review?.user?._id === rating?.user?._id);
                  return <ProductReviewCard key={rating._id} rating={rating} review={matchingReview} />;
                })
              ) : (
          ...
          {/* Rating Summary */}
          <Grid item xs={5}>
            <h1 className="text-xl font-semibold pb-2">Overall Rating</h1>
                ...
                <Grid container alignItems="center" gap={2} key={label}>
                  ...
                  <Grid item xs={7}>
                    <LinearProgress
                      ...
                      variant="determinate"
                      value={ratingPercentages[4 - index]} // Reverse order (5-star first)
                      color={['error', 'warning', 'primary', 'secondary', 'success'][index]}
                    />
                  </Grid>
                </Grid>
              ))}
